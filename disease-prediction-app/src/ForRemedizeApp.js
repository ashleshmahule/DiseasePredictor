...
class ForChatBotAvuCeo extends React.Component {
            ...
            <>
                <Container id='cont'>
                    <Row className="justify-content-md-center">
                        <Col >
                            <h2 id="choose">Choose the Symptoms You Have Been Experiencing Lately</h2>
                        </Col>
                    </Row>
...
export default ForChatBotAvuCeo;